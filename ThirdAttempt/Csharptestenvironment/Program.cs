...
namespace Csharptestenvironment
{
    class Program
    {
        ...
        {
            var doubleID = new List<Tuple<int, List<int>>>()
            {
                new Tuple<int, List<int>>(1, new List<int>(){2}),
                new Tuple<int, List<int>>(2, new List<int>(){1}),
                new Tuple<int, List<int>>(1, new List<int>(){1})
            };
            var invalid_reference = new List<Tuple<int, List<int>>>()
            {
                new Tuple<int, List<int>>(1, new List<int>(){2}),
                new Tuple<int, List<int>>(2, new List<int>(){1}),
                new Tuple<int, List<int>>(3, new List<int>(){6})
            };
